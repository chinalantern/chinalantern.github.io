          ...
          ? (r ||
              (r = new IntersectionObserver(
                function (e) {
                  e.forEach(function (e) {
                    var n;
                    e.isIntersecting && (null == (n = o.get(e.target)) || n(), o.delete(e.target));
                  });
                },
                {
                  rootMargin:
                    '4g' !== (null == c ? void 0 : c.effectiveType) || (null != c && c.saveData)
                      ? '2500px'
                      : '1250px',
                },
              )),
            function (n) {
              return (
                ...
                function () {
                  r && n.current && (o.delete(n.current), r.unobserve(n.current));
                }
              );
            })
          : function () {
...
//# sourceMappingURL=175-6b33fe4aa0644795186d.js.map
